...
type GlobalContractIdentifier struct {
	...
	// Types that are assignable to Variant:
	//
	//	*GlobalContractIdentifier_CodeHash_
	//	*GlobalContractIdentifier_AccountId_
	Variant isGlobalContractIdentifier_Variant `protobuf_oneof:"variant"`
}
...
func (*GlobalContractIdentifier) Descriptor() ([]byte, []int) {
	return file_payloads_near_common_common_proto_rawDescGZIP(), []int{3}
}

func (m *GlobalContractIdentifier) GetVariant() isGlobalContractIdentifier_Variant {
	if m != nil {
		return m.Variant
	}
	return nil
...
func (x *GlobalContractIdentifier) GetCodeHash() *GlobalContractIdentifier_CodeHash {
	if x, ok := x.GetVariant().(*GlobalContractIdentifier_CodeHash_); ok {
		return x.CodeHash
	}
	return nil
}

func (x *GlobalContractIdentifier) GetAccountId() *GlobalContractIdentifier_AccountId {
	if x, ok := x.GetVariant().(*GlobalContractIdentifier_AccountId_); ok {
		return x.AccountId
	}
	return nil
}

type isGlobalContractIdentifier_Variant interface {
	isGlobalContractIdentifier_Variant()
}

type GlobalContractIdentifier_CodeHash_ struct {
	CodeHash *GlobalContractIdentifier_CodeHash `protobuf:"bytes,1,opt,name=code_hash,json=codeHash,proto3,oneof"`
}

type GlobalContractIdentifier_AccountId_ struct {
	AccountId *GlobalContractIdentifier_AccountId `protobuf:"bytes,2,opt,name=account_id,json=accountId,proto3,oneof"`
}

func (*GlobalContractIdentifier_CodeHash_) isGlobalContractIdentifier_Variant() {}

func (*GlobalContractIdentifier_AccountId_) isGlobalContractIdentifier_Variant() {}
...
func (x *PublicKey_SECP256K1) Reset() {
	*x = PublicKey_SECP256K1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_payloads_near_common_common_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type GlobalContractIdentifier_CodeHash struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GlobalContractIdentifier_CodeHash) Reset() {
	*x = GlobalContractIdentifier_CodeHash{}
	if protoimpl.UnsafeEnabled {
		mi := &file_payloads_near_common_common_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GlobalContractIdentifier_CodeHash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlobalContractIdentifier_CodeHash) ProtoMessage() {}

func (x *GlobalContractIdentifier_CodeHash) ProtoReflect() protoreflect.Message {
	mi := &file_payloads_near_common_common_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlobalContractIdentifier_CodeHash.ProtoReflect.Descriptor instead.
func (*GlobalContractIdentifier_CodeHash) Descriptor() ([]byte, []int) {
	return file_payloads_near_common_common_proto_rawDescGZIP(), []int{3, 0}
}

func (x *GlobalContractIdentifier_CodeHash) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
type GlobalContractIdentifier_AccountId struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GlobalContractIdentifier_AccountId) Reset() {
	*x = GlobalContractIdentifier_AccountId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_payloads_near_common_common_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GlobalContractIdentifier_AccountId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlobalContractIdentifier_AccountId) ProtoMessage() {}

func (x *GlobalContractIdentifier_AccountId) ProtoReflect() protoreflect.Message {
	mi := &file_payloads_near_common_common_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlobalContractIdentifier_AccountId.ProtoReflect.Descriptor instead.
func (*GlobalContractIdentifier_AccountId) Descriptor() ([]byte, []int) {
	return file_payloads_near_common_common_proto_rawDescGZIP(), []int{3, 1}
}

func (x *GlobalContractIdentifier_AccountId) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_payloads_near_common_common_proto_rawDesc = []byte{
	...
	,
...
var file_payloads_near_common_common_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_payloads_near_common_common_proto_goTypes = []any{
	...
	(*GlobalContractIdentifier)(nil),           // 3: borealis.payloads.near.GlobalContractIdentifier
	(*Signature_ED25519)(nil),                  // 4: borealis.payloads.near.Signature.ED25519
	(*Signature_SECP256K1)(nil),                // 5: borealis.payloads.near.Signature.SECP256K1
	(*PublicKey_ED25519)(nil),                  // 6: borealis.payloads.near.PublicKey.ED25519
	(*PublicKey_SECP256K1)(nil),                // 7: borealis.payloads.near.PublicKey.SECP256K1
	(*GlobalContractIdentifier_CodeHash)(nil),  // 8: borealis.payloads.near.GlobalContractIdentifier.CodeHash
	(*GlobalContractIdentifier_AccountId)(nil), // 9: borealis.payloads.near.GlobalContractIdentifier.AccountId
}
var file_payloads_near_common_common_proto_depIdxs = []int32{
	...
	4, // 1: borealis.payloads.near.Signature.ed25519:type_name -> borealis.payloads.near.Signature.ED25519
	5, // 2: borealis.payloads.near.Signature.secp256k1:type_name -> borealis.payloads.near.Signature.SECP256K1
	6, // 3: borealis.payloads.near.PublicKey.ed25519:type_name -> borealis.payloads.near.PublicKey.ED25519
	7, // 4: borealis.payloads.near.PublicKey.secp256k1:type_name -> borealis.payloads.near.PublicKey.SECP256K1
	8, // 5: borealis.payloads.near.GlobalContractIdentifier.code_hash:type_name -> borealis.payloads.near.GlobalContractIdentifier.CodeHash
	9, // 6: borealis.payloads.near.GlobalContractIdentifier.account_id:type_name -> borealis.payloads.near.GlobalContractIdentifier.AccountId
...
func file_payloads_near_common_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_payloads_near_common_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GlobalContractIdentifier); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_payloads_near_common_common_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_payloads_near_common_common_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*GlobalContractIdentifier_CodeHash); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_payloads_near_common_common_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*GlobalContractIdentifier_AccountId); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_payloads_near_common_common_proto_msgTypes[3].OneofWrappers = []any{
		(*GlobalContractIdentifier_CodeHash_)(nil),
		(*GlobalContractIdentifier_AccountId_)(nil),
	}
	type x struct{}
